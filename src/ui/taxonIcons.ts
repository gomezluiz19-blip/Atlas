...
const BY_ICONIC: Record<string, TaxonIconKey> = {
  ...
  Insecta: "insect", Arachnida: "spider", Plantae: "plant", Fungi: "mushroom", Animalia: "insect", Chromista: "plant", Protozoa: "lichen",
};
...
export function taxonIcon(t: Partial<Taxon> & { ancestor_ids?: number[]; ancestry?: string }): TaxonIconKey {
  ...
  return BY_ICONIC[t.iconic_taxon_name ?? ""] ?? "plant";
}
